    ...
    <div class="d-flex justify-content-center" style="height: 750px">
        <div style="height: min-content">
            @if(count($orders)==0)
                ...
                <p style="text-align: center"><a href="/admin/orders/create"><img src="https://img.icons8.com/nolan/64/plus.png" width="50" height="50"/></a></p>
            @else
                <table style="margin: 100px 0; min-width: 100%;">
                    ...
                    @foreach($orders as $order)
                        <tr class="table-row">
                            ...
                            <td id="order_time">{{$order['staying']}}</td>
                            <td id="order_price">{{$order['time']}}</td>
                            <td id="order_staying_end">{{$order['staying_end']}}</td>
                            <td id="order_user_id">{{$order['user_id']}}</td>
                            <td id="order_place_id">{{$order['place_id']}}</td>
                            <td>
                    ...
                    <tr class="table-row">
                        ...
                        <td></td>
                        <td></td>
                        <td style="text-align: center"><a href="/admin/orders/create"><img src="https://img.icons8.com/nolan/64/plus.png" width="30" height="30"/></a></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
