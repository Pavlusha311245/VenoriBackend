 ...
 * @OA\Property(property="price", type="number", example=20.99),
 * @OA\Property(property="staying", type="integer", example=2),
 * @OA\Property(property="time", type="string", format="time", example="17:30"),
 * @OA\Property(property="staying_end", type="string", format="time", example="19:30"),
